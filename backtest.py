...
def backtest():
    # 1. Test Verisi Ayarları (Eğitim verisinden FARKLI bir tarih aralığı seçelim)
    TICKER_A = "GLD"
    TICKER_B = "GDX"
    START = "2024-01-01"  # Eğitim 2024'e kadardı, burası "Out-of-Sample" test
    END = "2024-12-01"
    ...
    while not done:
        ...
        # O anki portföy değerini kaydet (Env içindeki balance)
